      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your company profile and verification preferences.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="p-6 rounded-2xl bg-card border border-border">
              <h2 className="font-display text-xl font-bold mb-6">Company Profile</h2>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="contact" type="email" defaultValue="hr@technova.com" />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="api">API Endpoint (Optional)</Label>
                  <Input id="api" placeholder="https://api.yourcompany.com/webhook" />
                </div>
